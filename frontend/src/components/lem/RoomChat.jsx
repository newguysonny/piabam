...
import { FiSend, FiShare2, FiShoppingBag, FiChevronDown } from "react-icons/fi";
    ...
    <div className="relative flex flex-col bg-neutral-900 text-white">
      ...
      {showScrollButton && (
        <button
          ...
          className="absolute bottom-20 right-4 bg-blue-600 hover:bg-blue-500 text-white p-2 rounded-full shadow-md transition"
