...
export default function MealCrewLayout() {
  ...
  return (
    <div className="bg-neutral-900 text-gray-200 min-h-screen flex justify-center py-4">
      <div className="w-full max-w-md bg-neutral-900 rounded-xl shadow-lg overflow-hidden relative">
